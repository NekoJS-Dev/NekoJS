import { $ApiParameter, $ApiSignature, $ApiSymbolId, $ApiTypeRef, $ApiTypeRef$Kind } from "java:com/tkisor/nekojs/api/surface";
import { $ClassEditor, $GlobalDecl, $ProbeAddGlobalEventJS, $ProbeAssignTypeEventJS, $ProbeModifyTypeEventJS, $ProbeSnippetEventJS, $Snippet } from "java:com/tkisor/nekojs/probe/events";
import { $FieldDecl, $MethodDecl, $MethodDecl$MethodParam, $MethodDecl$Overload, $TypeDecl, $TypeDecl$Kind, $TypeDecl$TypeParam, $TypeSlot } from "java:com/tkisor/nekojs/probe/ir";
...
import { $AbstractStringBuilder, $Appendable, $AutoCloseable, $Boolean, $CharSequence, $Character, $Class, $ClassLoader, $Cloneable, $Comparable, $Double, $Enum, $Enum$EnumDesc, $Integer, $Iterable, $Long, $Module, $ModuleLayer, $ModuleLayer$Controller, $NamedPackage, $Number, $Package, $Readable, $Record, $Runnable, $Runtime$Version, $StackTraceElement, $String, $StringBuffer, $Thread, $Thread$Builder, $Thread$Builder$OfPlatform, $Thread$Builder$OfVirtual, $Thread$State, $Thread$UncaughtExceptionHandler, $ThreadGroup, $Throwable } from "java:java/lang";

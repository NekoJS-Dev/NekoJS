...
class BlockSpecTest {
    ...
    @Test
    void blockSpecDeclaresAllUnifiedMethods() {
        assertDoesNotThrow(() -> BlockSpec.class.getMethod("neko$getId"));
    }

    @Test
    void allMethodsAreDefaultWithSentinel() throws Exception {
        var instance = new BlockSpec() {};
        for (java.lang.reflect.Method method : BlockSpec.class.getDeclaredMethods()) {

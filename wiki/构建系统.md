...
> 本页讲 NekoJS 单仓自身的构建：多版本 × 多加载器的组织、怎么编译各平台、守卫纪律、CI。**插件作者不需要读本页**（除非好奇）；贡献代码 / 发版需要。结构判定与守卫纪律的完整依据见 [ADR-0007](../docs/adr/0007-module-boundaries.md) / [ADR-0008](../docs/adr/0008-guard-discipline.md)。
...
- fabric 节点目前没有测试：共享测试树整棵挂在 neoforge 守卫里，等 fabric 侧移植完成后再打开。

...
- 一棵源码树同时支持 NeoForge 26.1 / 26.2 / 1.21.1，Fabric 26.1.2 与 26.2.0 节点可构建，CI 会校验两个上传的 Fabric jar 并运行对应 development runtime smoke；两个 Fabric 制品均未开启外部发布。Cleanroom 1.12.2 在独立的 legacy 分支维护，不在本仓库构建。

...
- [ ] 为两个平台补 symlink 逃逸专项 runnable/Java 测试，并同步 1.21.1 run-dir smoke fixture。
...
- [ ] 继续把 parser edge case 从 fixture 扩成 invalid/diagnostic 覆盖，例如 computed export/import 边界、re-export span、decorator/complex class element 边界和重复参数/catch binding 诊断。

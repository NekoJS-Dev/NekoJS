...
public class PotionRegistryEventJS {
    ...
    public PotionBuilderJS create(Identifier id) {
        PotionBuilderJS builder = new PotionBuilderJS(id);
        builders.add(builder);
        return builder;
    }
    public void create(String id, java.util.function.Consumer<PotionBuilderJS> consumer) {
        PotionBuilderJS builder = create(Identifier.parse(id));

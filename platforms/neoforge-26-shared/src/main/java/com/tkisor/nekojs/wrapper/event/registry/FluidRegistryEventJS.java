...
public class FluidRegistryEventJS {
    ...
    private static final Map<Identifier, Fluid> REGISTERED_SOURCES = new HashMap<>();
    private static final Map<Identifier, Fluid> REGISTERED_FLOWING = new HashMap<>();
    private static final Map<Identifier, LiquidBlock> REGISTERED_BLOCKS = new HashMap<>();
    private static final Map<Identifier, Item> REGISTERED_BUCKETS = new HashMap<>();
    ...
    public void create(Identifier id, Consumer<FluidBuilderJS> consumer) {
    ...
    public static void registerFluids(RegisterEvent event) {
        for (FluidBuilderJS builder : PENDING.values()) {
            Identifier id = builder.getLocation();
            Identifier flowingId = builder.getFlowingLocation();
    ...
    public static void registerItems(RegisterEvent event) {
        for (FluidBuilderJS builder : PENDING.values()) {
            ...
            Identifier id = builder.getLocation();
            Identifier bucketId = builder.getBucketLocation();

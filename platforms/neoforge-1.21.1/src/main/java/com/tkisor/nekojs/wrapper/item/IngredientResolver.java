...
public final class IngredientResolver {
    ...
    public static Ingredient fromString(String raw) {
        ...
        ResourceLocation location = ResourceLocation.tryParse(id.startsWith("#") ? id.substring(1) : id);
        if (location == null) {
        ...
        if (id.startsWith("#")) {
            ...
            return Ingredient.of(tag.get().stream().map(Holder::value).toArray(Item[]::new));
        }

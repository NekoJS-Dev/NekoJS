...
public class NekoErrorTracker {
    ...
    public static Component getErrorComponent() {
        int errorCount = ERRORS.size(); // 假设 ERRORS 是你定义好的集合

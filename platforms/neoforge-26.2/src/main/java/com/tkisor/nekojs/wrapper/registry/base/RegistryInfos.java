...
public class RegistryInfos {
    ...
    public RegistryInfos(Set<Class<?>> classesToScan, Collection<RegistryInfo<?>> additionalInfos) {
    ...
    public <T> RegistryInfo<T> get(ResourceKey<Registry<T>> key) {
        return (RegistryInfo<T>) infos.get(key.identifier());
    }

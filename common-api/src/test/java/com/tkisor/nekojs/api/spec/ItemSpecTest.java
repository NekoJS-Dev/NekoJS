...
class ItemSpecTest {
    ...
    @Test
    void itemSpecDeclaresAllUnifiedMethods() {
        assertDoesNotThrow(() -> ItemSpec.class.getMethod("neko$getId"));
    }

    @Test
    void allMethodsAreDefaultWithSentinel() throws Exception {
        var instance = new ItemSpec() {};
        for (java.lang.reflect.Method method : ItemSpec.class.getDeclaredMethods()) {
